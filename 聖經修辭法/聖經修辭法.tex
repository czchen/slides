...
\begin{frame}{平行體：定義與特點}
  \begin{itemize}
    \item 語源與定義：源自希臘文 \textgreek{παραλληλισμός}，是希伯來詩歌的核心結構與修辭基石。連續詩句在意涵、句法或思想結構上相互呼應。
    \item 思想的韻律：不同於西方詩歌依賴格律與押韻，希伯來詩歌運作於「思想、意象與結構概念的押韻」。
  \end{itemize}
\end{frame}
...
\begin{frame}{平行體：主要類型（二）}
  \begin{itemize}
    ...
    \item 喻意平行 (Emblematic Parallelism)：一句使用具體意象或明喻（常帶「如」、「像」），另一句說明屬靈真理。\\
