  ...
  \begin{itemize}
    ...
    \item 巴別塔敘事 (\bibleref{Genesis 11:1-9})
      \begin{itemize}
        ...
        \item \quad\quad (C) 「要傳揚我們的名，\textbf{免得我們分散全地}」 (\bibleref{Genesis 11:4})
        ...
        \item \quad\quad (C') \textbf{耶和華使他們從那裡分散在全地上} (\bibleref{Genesis 11:8})
...
\begin{frame}{首尾呼應 (Inclusio)}
  \begin{itemize}
    ...
    \item 創造大篇章 (\bibleref{Genesis 1:1} \textemdash\ \bibleref{Genesis 2:1})
      \begin{itemize}
        \item \textbf{首 (\bibleref{Genesis 1:1})} 起初，神創造\textbf{天地}。
        \item \textbf{尾 (\bibleref{Genesis 2:1})} \textbf{天地}萬物都造齊了。
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{本章修辭格總覽}
  \begin{itemize}
    ...
    \item 換喻/轉喻 (Metonymy) / 提喻 (Synecdoche)
