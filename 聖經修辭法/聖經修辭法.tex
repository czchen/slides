...
\begin{frame}{平行體 (Parallelism)}
  \begin{itemize}
    \item 希伯來詩歌的核心結構與修辭基石。連續詩句在意涵、句法或思想結構上相互呼應。
    \item 不同於西方詩歌依賴格律與押韻，希伯來詩歌運作於「思想、意象與結構概念的押韻」。
  \end{itemize}
\end{frame}

\begin{frame}{平行體：核心功能}
  \begin{itemize}
...
\begin{frame}{同義平行與對照平行}
  \begin{itemize}
    \item 同義平行：第二句使用不同詞彙重述或強化第一句的核心概念。\\
      (\bibleref{Psalms 19:1}) 諸天述說神的榮耀；穹蒼傳揚他的手段。
    \item 對照平行：第二句與第一句形成鮮明對比，透過反襯突顯真理與智慧。\\
      (\bibleref{Proverbs 10:1}) ... 智慧之子使父親歡樂；愚昧之子叫母親擔憂。
  \end{itemize}
\end{frame}

\begin{frame}{綜合平行與倒裝平行}
  \begin{itemize}
    \item 綜合平行：第二句不單純重複，而是補充、延伸或進一步發展第一句的思想。\\
      (\bibleref{Psalm 23:1-2}) 耶和華是我的牧者，我必不致缺乏。他使我躺臥在青草地上，領我在可安歇的水邊。
    \item 倒裝平行：兩句或多句的語法結構與概念呈倒置對稱 (A-B // B'-A')。\\
      (\bibleref{Matthew 23:12}) 凡高抬自己的，必被降卑；凡自己謙卑的，必被升高。\\
      (\bibleref{Proverbs 6:23}) ... 誡命是燈，訓誨是光 ...\\
      \begin{hebrew}
...
\begin{frame}{喻意平行與階梯平行}
  \begin{itemize}
    \item 喻意平行：一句使用具體意象或明喻，另一句說明屬靈真理。\\
      (\bibleref{Psalm 103:13}) 父親怎樣憐恤他的兒女，耶和華也怎樣憐恤敬畏他的人！
    \item 階梯平行：第二句重複第一句的部分詞彙，並層層遞進累積，直到達到最高潮。\\
      (\bibleref{Psalm 29:1}) 神的眾子啊！要歸給耶和華，你們要把榮耀和能力歸給耶和華。\\
      \begin{hebrew}
        (\biblerefhebrew{Psalm 29:1}) ... הָבוּ לַיהוָה בְּנֵי אֵלִים הָבוּ לַיהוָה כָּבוֹד וָעֹז׃
      \end{hebrew}
  \end{itemize}
\end{frame}
...
\begin{frame}{微觀交叉對稱}
  \begin{itemize}
    ...
    \item 勝過罪的終極根基 (\bibleref{IJohn 3:9} (A-B-X-B'-A'))
      \begin{itemize}
...
\begin{frame}{嵌套交叉對稱：婦人與龍的內部嵌套}
  \begin{itemize}
    \item 啟示錄第十二章內部嵌套交叉 (Revelation 12:1-17)
      \begin{itemize}
        ...
        \item \quad\quad\quad \textbf{(X) 撒但與其使者被摔在地上，神的國度來臨 (\bibleref{Revelation 12:9-10})} 【核心軸心】
      ...
      \end{itemize}
    \item 全書以宏觀聚焦第十二章，而第十二章內部又以嵌套交叉雙重聚焦於**撒但被摔下與神的國度來臨 (\bibleref{Revelation 12:9-10})**。
  \end{itemize}
\end{frame}
...
\begin{frame}{本章修辭格總覽}
  \begin{itemize}
    \item 明喻 (Simile) / 暗喻 (Metaphor) / 借喻 (Hypocatastasis) / 換喻 (Metonymy) / 提喻 (Synecdoche)
