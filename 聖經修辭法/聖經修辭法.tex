  ...
  \begin{itemize}
    \item 平行體 (Parallelism)
      \begin{itemize}
        ...
        \item 倒裝平行 (Chiastic Parallelism)
        \item 喻意平行 (Emblematic Parallelism)
        \item 階梯平行 (Climactic Parallelism)
      \end{itemize}
    \item 交叉對稱 (Chiasmus)
    \item 首尾呼應 (Inclusio)
    \item 兩極表達法 (Merism)
...
\begin{frame}{平行體：主要類型（一）}
  \begin{itemize}
    \item 同義平行 (Synonymous Parallelism)：第二句使用不同詞彙重述或強化第一句的核心概念。\\
      (\bibleref{Psalms 19:1}) 諸天述說神的榮耀；穹蒼傳揚他的手段。
    \item 對照平行 (Antithetic Parallelism)：第二句與第一句形成鮮明對比，透過反襯突顯真理與智慧。\\
      (\bibleref{Proverbs 10:1}) ... 智慧之子使父親歡樂；愚昧之子叫母親擔憂。
    \item 綜合平行 (Synthetic Parallelism)：第二句不單純重複，而是補充、延伸或進一步發展第一句的思想。\\
      (\bibleref{Psalm 23:1-2}) 耶和華是我的牧者，我必不致缺乏。他使我躺臥在青草地上，領我在可安歇的水邊。
  \end{itemize}
\end{frame}

\begin{frame}{平行體：主要類型（二）}
  \begin{itemize}
    \item 倒裝平行 (Chiastic Parallelism)：兩句或多句的語法結構與概念呈倒置對稱 (A-B-B'-A')。\\
      (\bibleref{Matthew 23:12}) 凡高抬自己的，必被降卑；凡自己謙卑的，必被升高。
    \item 喻意平行 (Emblematic Parallelism)：一句使用具體意象或明喻，另一句說明屬靈真理。\\
      (\bibleref{Psalm 103:13}) 父親怎樣憐恤他的兒女，耶和華也怎樣憐恤敬畏他的人！
    \item 階梯平行 (Climactic Parallelism)：第二句重複第一句的部分詞彙，並層層遞進累積，直到達到最高潮。\\
