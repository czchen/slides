...
\begin{frame}{微觀交叉對稱}
  ...
  \end{itemize}
\end{frame}
\begin{frame}{2. 段落交叉對稱 (Pericope Chiasm)}
  \begin{itemize}
...
\begin{frame}{4. 嵌套交叉對稱：婦人與龍的內部嵌套}
  \begin{itemize}
    \item \textbf{啟示錄第 12 章內部嵌套交叉 (Revelation 12:1-17)}：
      \begin{itemize}
      ...
      \end{itemize}
    \item \textbf{雙重對稱焦點}：全書以 7x7 宏觀聚焦第 12 章，而第 12 章內部又以嵌套交叉雙重聚焦於**撒但被摔下與神的國度來臨 (\bibleref{Revelation 12:9-10})**。
  \end{itemize}
\end{frame}
