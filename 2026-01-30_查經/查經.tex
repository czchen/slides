...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item
      ...
      \end{hebrew}
    \item 曠野 \texthebrew{מִדְבָּר}\ 跟話語 \texthebrew{דָבָר} 字根相同，曠野就是聽到神說話的地方
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item \texthebrew{שְׂאוּ אֶת־רֹאשׁ}\ 字面的意思是抬起頭，在聖經中除了統計人數，還有以下的用法：
      \begin{itemize}
        \item 升官: 三天之內，法老必\alert{抬起你的頭}，恢復你的官位。你仍要把法老的杯送到他的手裏，就像你之前做他司酒長時所做的一樣。(\bibleref{Gn 40:13})
        \item 砍頭: 三天之內，法老必\alert{抬起你的頭}，把你掛在木頭上；飛鳥要啄食你身上的肉。」(\bibleref{Gn 40:19})
        \item 敬拜: 眾城門哪，你們要\alert{抬起頭來}！永久的門戶，你們要被舉起！那榮耀的王將要進來！(\bibleref{Ps 24:7})
      \end{itemize}
    \item 被神數點也表示被神注意，
  \end{itemize}
\end{frame}
