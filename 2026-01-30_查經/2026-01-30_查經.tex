...
\addbibresource{2026-01-30_查經.bib}
...
\begin{frame}
  \frametitle{前情提要 - \bibleref{Ex 24-40}\ 的交錯對稱\ \parencite{Chiasm_Exodus_24-40}}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{tabular}{cl}
    ...
    \midrule
    \texthebrew{דָּבָר}\ (話語)  & \texthebrew{מִדְבָּר}\ (曠野)  \\
