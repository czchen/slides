...
\begin{frame}{安息日的擴大 \textemdash 安息年}
	...
	\begin{itemize}
		\item 這裡的\alert{一詞七用}，是聖經用來強調的一個修辭方式，強調\alert{除了人之外，就連土地也要承認耶和華掌管全地的王權}。\parencite{安息年}
	\end{itemize}
\end{frame}
...
\begin{frame}{赦免以色列人拜金牛犢的罪 \textendash\ 時間線}
	\begin{itemize}
		...
		\item 4/18\textendash\ 5/28: 第二天，摩西上山贖罪\alert{四十晝夜} (\bibleref{Ex 32:30; Dt 9:18,25})。
